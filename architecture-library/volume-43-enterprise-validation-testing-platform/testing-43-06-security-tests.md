...
Version: draft
Status: Active
Document ID: architecture-library/volume-43-enterprise-validation-testing-platform/testing-43-06-security-tests.md

## Purpose
Validates vault, permissions, sandbox, secrets, APIs, and plugin security gates.
