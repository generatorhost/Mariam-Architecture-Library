...
**Version:** v64 draft
**Status:** Draft
**Document ID:** MAL-V12-VERSIONING-02

## Purpose
Provide official implementation guidance for Versioning inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V12-VERSIONING-02 | Governs Versioning. |
...
| --- | --- | --- | --- |
| v64 draft | 2026-06-29 | Draft | Added official documentation for Versioning. |
