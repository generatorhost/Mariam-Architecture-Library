...
**Version:** v63 draft
**Status:** Draft
**Document ID:** MAL-V12-INDEXING-02

## Purpose
Provide official implementation guidance for Indexing inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V12-INDEXING-02 | Governs Indexing. |
...
| --- | --- | --- | --- |
| v63 draft | 2026-06-29 | Draft | Added official documentation for Indexing. |
