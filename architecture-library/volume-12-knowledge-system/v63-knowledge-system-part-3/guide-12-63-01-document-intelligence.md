...
**Version:** v63 draft
**Status:** Draft
**Document ID:** MAL-V12-DOCUMENT-INTELLIGENCE-01

## Purpose
Provide official implementation guidance for Document Intelligence inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V12-DOCUMENT-INTELLIGENCE-01 | Governs Document Intelligence. |
| Volume 05 | Engineering standards reference. |
| RELEASE_NOTES_v63_draft.md | Release evidence. |

## Version History
| Version | Date | Status | Notes |
| --- | --- | --- | --- |
| v63 draft | 2026-06-29 | Draft | Added official documentation for Document Intelligence. |
