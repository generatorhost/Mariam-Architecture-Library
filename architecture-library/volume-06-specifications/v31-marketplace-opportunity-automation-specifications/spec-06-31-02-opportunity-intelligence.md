# Opportunity Intelligence Specification

**Title:** Opportunity Intelligence Specification
**Version:** v31 draft
**Status:** Draft
**Specification ID:** MAL-V06-OPPORTUNITY-INTELLIGENCE-SPEC-02
...
## Purpose
Define implementation-level requirements for Opportunity Intelligence in Mariam AI Enterprise OS so engineering teams can build, test, operate, and govern it consistently.
...
## Responsibilities
- Maintain authoritative state and lifecycle rules for Opportunity Intelligence.
...
## Public Interfaces
- `create_opportunity_intelligence(request)`
- `get_opportunity_intelligence_state(id)`
- `validate_opportunity_intelligence(payload)`
- `execute_opportunity_intelligence(command)`
- `audit_opportunity_intelligence(scope)`
...
## Events
- `opportunity-intelligence.created`
- `opportunity-intelligence.validated`
- `opportunity-intelligence.started`
- `opportunity-intelligence.completed`
- `opportunity-intelligence.failed`
- `opportunity-intelligence.recovered`
- `opportunity-intelligence.accepted`
...
| Source | Relationship |
| --- | --- |
| MAL-V06-OPPORTUNITY-INTELLIGENCE-SPEC-02 | Defines v31 implementation requirements for Opportunity Intelligence. |
| Volume 03 | Blueprint source. |
| Volume 05 | Engineering standards source. |
| RELEASE_NOTES_v31_draft.md | Release evidence. |

## Version History
| Version | Date | Status | Notes |
| --- | --- | --- | --- |
| v31 draft | 2026-06-29 | Draft | Initial specification for Opportunity Intelligence. |
