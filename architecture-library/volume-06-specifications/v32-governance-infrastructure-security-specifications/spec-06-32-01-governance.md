...
**Version:** v32 draft
**Status:** Draft
**Specification ID:** MAL-V06-GOVERNANCE-SPEC-01
...
## Purpose
Define implementation-level requirements for Governance in Mariam AI Enterprise OS so engineering teams can build, test, operate, and govern it consistently.
...
## Responsibilities
- Maintain authoritative state and lifecycle rules for Governance.
...
## Public Interfaces
- `create_governance(request)`
- `get_governance_state(id)`
- `validate_governance(payload)`
- `execute_governance(command)`
- `audit_governance(scope)`
...
| Source | Relationship |
| --- | --- |
| MAL-V06-GOVERNANCE-SPEC-01 | Defines v32 implementation requirements for Governance. |
...
| --- | --- | --- | --- |
| v32 draft | 2026-06-29 | Draft | Initial specification for Governance. |
