...
**Version:** v25 draft
**Status:** Draft
**Specification ID:** MAL-V06-CORE-SPEC-007
...
## Purpose
Define executable requirements for configuration loading, validation, secret separation, environment overrides, and safe inspection in Mariam AI Enterprise OS.

## Scope
This specification covers functional behavior, non-functional expectations, interfaces, events, storage, security, observability, failure handling, recovery, tests, and implementation notes for configuration loading, validation, secret separation, environment overrides, and safe inspection.
...
- `POST /core/configuration/commands`
- `GET /core/configuration/events`
...
## Events
- ConfigurationCommandReceived
- ConfigurationCommandAccepted
- ConfigurationCommandRejected
- ConfigurationStateChanged
- ConfigurationFailureDetected
