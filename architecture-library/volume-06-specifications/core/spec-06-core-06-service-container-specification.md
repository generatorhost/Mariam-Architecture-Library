...
**Version:** v25 draft
**Status:** Draft
**Specification ID:** MAL-V06-CORE-SPEC-006
...
## Purpose
Define executable requirements for service registration, dependency resolution, lifecycle hooks, privileged services, and disposal in Mariam AI Enterprise OS.

## Scope
This specification covers functional behavior, non-functional expectations, interfaces, events, storage, security, observability, failure handling, recovery, tests, and implementation notes for service registration, dependency resolution, lifecycle hooks, privileged services, and disposal.
...
## Public Interfaces
- `GET /core/servicecontainer/status`
- `POST /core/servicecontainer/commands`
- `GET /core/servicecontainer/events`
...
## Events
- ServiceContainerCommandReceived
- ServiceContainerCommandAccepted
- ServiceContainerCommandRejected
- ServiceContainerStateChanged
- ServiceContainerFailureDetected
- ServiceContainerRecovered
