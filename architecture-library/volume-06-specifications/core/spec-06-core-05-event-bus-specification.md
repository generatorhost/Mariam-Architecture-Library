...
**Version:** v25 draft
**Status:** Draft
**Specification ID:** MAL-V06-CORE-SPEC-005
...
## Purpose
Define executable requirements for core event envelope, publication, subscription, delivery failure, dead-letter, and correlation behavior in Mariam AI Enterprise OS.

## Scope
This specification covers functional behavior, non-functional expectations, interfaces, events, storage, security, observability, failure handling, recovery, tests, and implementation notes for core event envelope, publication, subscription, delivery failure, dead-letter, and correlation behavior.
...
## Public Interfaces
- `GET /core/eventbus/status`
- `POST /core/eventbus/commands`
...
- EventBusCommandAccepted
- EventBusCommandRejected
- EventBusStateChanged
- EventBusFailureDetected
- EventBusRecovered
