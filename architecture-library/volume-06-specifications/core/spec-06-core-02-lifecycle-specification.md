...
**Version:** v25 draft
**Status:** Draft
**Specification ID:** MAL-V06-CORE-SPEC-002
...
## Purpose
Define executable requirements for core lifecycle states, transition validation, readiness gates, degradation, maintenance, and shutdown in Mariam AI Enterprise OS.

## Scope
This specification covers functional behavior, non-functional expectations, interfaces, events, storage, security, observability, failure handling, recovery, tests, and implementation notes for core lifecycle states, transition validation, readiness gates, degradation, maintenance, and shutdown.
...
## Public Interfaces
- `GET /core/lifecycle/status`
- `POST /core/lifecycle/commands`
- `GET /core/lifecycle/events`
