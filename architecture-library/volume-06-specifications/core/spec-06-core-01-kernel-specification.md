...
**Version:** v25 draft
**Status:** Draft
**Specification ID:** MAL-V06-CORE-SPEC-001
...
## Purpose
Define executable requirements for kernel boot, trusted service access, invariant enforcement, and orderly shutdown in Mariam AI Enterprise OS.

## Scope
This specification covers functional behavior, non-functional expectations, interfaces, events, storage, security, observability, failure handling, recovery, tests, and implementation notes for kernel boot, trusted service access, invariant enforcement, and orderly shutdown.
...
- `POST /core/kernel/commands`
- `GET /core/kernel/events`
...
## Events
- KernelCommandReceived
- KernelCommandAccepted
- KernelCommandRejected
- KernelStateChanged
- KernelFailureDetected
- KernelRecovered
