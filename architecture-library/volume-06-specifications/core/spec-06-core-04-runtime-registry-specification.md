...
**Version:** v25 draft
**Status:** Draft
**Specification ID:** MAL-V06-CORE-SPEC-004
...
## Purpose
Define executable requirements for runtime manifest registration, compatibility metadata, deprecation, and lookup behavior in Mariam AI Enterprise OS.

## Scope
This specification covers functional behavior, non-functional expectations, interfaces, events, storage, security, observability, failure handling, recovery, tests, and implementation notes for runtime manifest registration, compatibility metadata, deprecation, and lookup behavior.
...
## Public Interfaces
- `GET /core/runtimeregistry/status`
- `POST /core/runtimeregistry/commands`
- `GET /core/runtimeregistry/events`
...
## Events
- RuntimeRegistryCommandReceived
- RuntimeRegistryCommandAccepted
- RuntimeRegistryCommandRejected
- RuntimeRegistryStateChanged
- RuntimeRegistryFailureDetected
- RuntimeRegistryRecovered
