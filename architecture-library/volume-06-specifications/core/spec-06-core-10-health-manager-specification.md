...
**Version:** v25 draft
**Status:** Draft
**Specification ID:** MAL-V06-CORE-SPEC-010
...
## Purpose
Define executable requirements for readiness, liveness, dependency checks, degradation, incident signals, and health reporting in Mariam AI Enterprise OS.

## Scope
This specification covers functional behavior, non-functional expectations, interfaces, events, storage, security, observability, failure handling, recovery, tests, and implementation notes for readiness, liveness, dependency checks, degradation, incident signals, and health reporting.
...
## Public Interfaces
- `GET /core/healthmanager/status`
- `POST /core/healthmanager/commands`
- `GET /core/healthmanager/events`
...
## Events
- HealthManagerCommandReceived
- HealthManagerCommandAccepted
- HealthManagerCommandRejected
- HealthManagerStateChanged
- HealthManagerFailureDetected
- HealthManagerRecovered
