...
**Title:** Self Healing Specification
**Version:** v28 draft
**Status:** Draft
**Specification ID:** MAL-V06-EXEC-SPEC-14
...
## Purpose
Defines automated repair behaviors that restore execution health without violating governance, security, or acceptance constraints. This specification makes the behavior executable by defining required responsibilities, interfaces, events, persistence rules, failure handling, and acceptance evidence for Mariam AI Enterprise OS.

## Scope
- Covers runtime behavior required for self healing inside the enterprise execution layer.
...
## Responsibilities
- Maintain authoritative execution state for the self healing capability.
...
| Source | Relationship |
| --- | --- |
| MAL-V06-EXEC-SPEC-14 | Defines v28 Execution OS requirements for Self Healing. |
| MAL-V03-B03-20-003 | Primary Blueprint source. |
...
| --- | --- | --- | --- |
| v28 draft | 2026-06-29 | Draft | Initial Execution OS specification for Self Healing. |
