...
**Title:** Agent Routing Specification
**Version:** v28 draft
**Status:** Draft
**Specification ID:** MAL-V06-EXEC-SPEC-06
...
## Purpose
Defines assignment, routing, and rerouting of tasks to agents based on capability, availability, policy, context, and performance. This specification makes the behavior executable by defining required responsibilities, interfaces, events, persistence rules, failure handling, and acceptance evidence for Mariam AI Enterprise OS.

## Scope
- Covers runtime behavior required for agent routing inside the enterprise execution layer.
...
## Responsibilities
- Maintain authoritative execution state for the agent routing capability.
...
| Source | Relationship |
| --- | --- |
| MAL-V06-EXEC-SPEC-06 | Defines v28 Execution OS requirements for Agent Routing. |
| MAL-V03-B03-03-007 | Primary Blueprint source. |
...
| --- | --- | --- | --- |
| v28 draft | 2026-06-29 | Draft | Initial Execution OS specification for Agent Routing. |
