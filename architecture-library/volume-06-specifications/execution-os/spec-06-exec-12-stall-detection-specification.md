...
**Title:** Stall Detection Specification
**Version:** v28 draft
**Status:** Draft
**Specification ID:** MAL-V06-EXEC-SPEC-12
...
## Purpose
Defines detection of blocked, idle, looping, waiting, degraded, and low-progress execution states. This specification makes the behavior executable by defining required responsibilities, interfaces, events, persistence rules, failure handling, and acceptance evidence for Mariam AI Enterprise OS.

## Scope
- Covers runtime behavior required for stall detection inside the enterprise execution layer.
...
## Responsibilities
- Maintain authoritative execution state for the stall detection capability.
...
| Source | Relationship |
| --- | --- |
| MAL-V06-EXEC-SPEC-12 | Defines v28 Execution OS requirements for Stall Detection. |
| MAL-V03-B03-17-001 | Primary Blueprint source. |
...
| --- | --- | --- | --- |
| v28 draft | 2026-06-29 | Draft | Initial Execution OS specification for Stall Detection. |
