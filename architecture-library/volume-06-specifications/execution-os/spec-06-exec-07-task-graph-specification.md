...
**Version:** v28 draft
**Status:** Draft
**Specification ID:** MAL-V06-EXEC-SPEC-07
...
## Purpose
Defines the directed execution graph used to represent tasks, dependencies, gates, retries, evidence, and completion state. This specification makes the behavior executable by defining required responsibilities, interfaces, events, persistence rules, failure handling, and acceptance evidence for Mariam AI Enterprise OS.

## Scope
- Covers runtime behavior required for task graph inside the enterprise execution layer.
...
## Responsibilities
- Maintain authoritative execution state for the task graph capability.
...
| Source | Relationship |
| --- | --- |
| MAL-V06-EXEC-SPEC-07 | Defines v28 Execution OS requirements for Task Graph. |
| MAL-V03-B03-08-003 | Primary Blueprint source. |
...
| --- | --- | --- | --- |
| v28 draft | 2026-06-29 | Draft | Initial Execution OS specification for Task Graph. |
