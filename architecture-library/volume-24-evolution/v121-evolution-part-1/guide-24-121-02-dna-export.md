...
**Version:** v121 draft
**Status:** Draft
**Document ID:** MAL-V24-DNA-EXPORT-02

## Purpose
Provide official implementation guidance for DNA Export inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V24-DNA-EXPORT-02 | Governs DNA Export. |
...
| --- | --- | --- | --- |
| v121 draft | 2026-06-29 | Draft | Added official documentation for DNA Export. |
