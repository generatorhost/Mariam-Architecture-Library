...
**Version:** v96 draft
**Status:** Draft
**Document ID:** MAL-V19-SCORING-02

## Purpose
Provide official implementation guidance for Scoring inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V19-SCORING-02 | Governs Scoring. |
...
| --- | --- | --- | --- |
| v96 draft | 2026-06-29 | Draft | Added official documentation for Scoring. |
