...
**Version:** v55 draft
**Status:** Draft
**Document ID:** MAL-V10-ROLES-01

## Purpose
Provide official implementation guidance for Roles inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V10-ROLES-01 | Governs Roles. |
...
| --- | --- | --- | --- |
| v55 draft | 2026-06-29 | Draft | Added official documentation for Roles. |
