...
**Version:** v36 draft
**Status:** Draft
**Document ID:** MAL-V07-REPOSITORY-LAYOUT-01

## Purpose
Provide official implementation guidance for Repository Layout inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V07-REPOSITORY-LAYOUT-01 | Governs Repository Layout. |
...
| --- | --- | --- | --- |
| v36 draft | 2026-06-29 | Draft | Added official documentation for Repository Layout. |
