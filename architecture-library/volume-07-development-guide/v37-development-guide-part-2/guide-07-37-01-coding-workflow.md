...
**Version:** v37 draft
**Status:** Draft
**Document ID:** MAL-V07-CODING-WORKFLOW-01

## Purpose
Provide official implementation guidance for Coding Workflow inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V07-CODING-WORKFLOW-01 | Governs Coding Workflow. |
...
| --- | --- | --- | --- |
| v37 draft | 2026-06-29 | Draft | Added official documentation for Coding Workflow. |
