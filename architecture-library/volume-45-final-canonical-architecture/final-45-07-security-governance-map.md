# Security and Governance Map

Version: draft
Status: Active
Document ID: architecture-library/volume-45-final-canonical-architecture/final-45-07-security-governance-map.md

## Purpose
Maps defense swarm, compliance, policies, permissions, approvals, and audit.
