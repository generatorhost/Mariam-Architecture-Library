...
Version: draft
Status: Active
Document ID: architecture-library/volume-45-final-canonical-architecture/final-45-04-plugin-map.md

## Purpose
Plugins are apps externally and business units internally.
