...
Version: draft
Status: Active
Document ID: architecture-library/volume-45-final-canonical-architecture/final-45-08-experience-map.md

## Purpose
Simple UI, mobile-first, chat plus apps, progressive disclosure, and plugin workspaces.
