...
**Version:** v117 draft
**Status:** Draft
**Document ID:** MAL-V23-ASSETS-02

## Purpose
Provide official implementation guidance for Assets inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V23-ASSETS-02 | Governs Assets. |
...
| --- | --- | --- | --- |
| v117 draft | 2026-06-29 | Draft | Added official documentation for Assets. |
