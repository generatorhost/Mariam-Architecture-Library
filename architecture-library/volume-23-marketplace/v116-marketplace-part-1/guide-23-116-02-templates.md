...
**Version:** v116 draft
**Status:** Draft
**Document ID:** MAL-V23-TEMPLATES-02

## Purpose
Provide official implementation guidance for Templates inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V23-TEMPLATES-02 | Governs Templates. |
...
| --- | --- | --- | --- |
| v116 draft | 2026-06-29 | Draft | Added official documentation for Templates. |
