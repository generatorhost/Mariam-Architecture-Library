# Snapshotted Configs Pattern

Version: draft
Status: Active
Document ID: architecture-library/volume-35-external-intelligence-program/snapshotted-configs-pattern.md

## Purpose
Long running missions use config snapshots to prevent behavior drift during execution.
