...
**Version:** v106 draft
**Status:** Draft
**Document ID:** MAL-V21-SANDBOX-02

## Purpose
Provide official implementation guidance for Sandbox inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V21-SANDBOX-02 | Governs Sandbox. |
...
| --- | --- | --- | --- |
| v106 draft | 2026-06-29 | Draft | Added official documentation for Sandbox. |
