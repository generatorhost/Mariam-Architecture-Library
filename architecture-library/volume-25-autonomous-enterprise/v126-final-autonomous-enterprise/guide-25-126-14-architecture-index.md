...
**Version:** v126 draft
**Status:** Draft
**Document ID:** MAL-V25-ARCHITECTURE-INDEX-14

## Purpose
Provide official implementation guidance for Architecture Index inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V25-ARCHITECTURE-INDEX-14 | Governs Architecture Index. |
...
| --- | --- | --- | --- |
| v126 draft | 2026-06-29 | Draft | Added official documentation for Architecture Index. |
