...
**Version:** v126 draft
**Status:** Draft
**Document ID:** MAL-V25-REMOTE-WORK-02

## Purpose
Provide official implementation guidance for Remote Work inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V25-REMOTE-WORK-02 | Governs Remote Work. |
...
| --- | --- | --- | --- |
| v126 draft | 2026-06-29 | Draft | Added official documentation for Remote Work. |
