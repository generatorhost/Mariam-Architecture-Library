...
**Version:** v76 draft
**Status:** Draft
**Document ID:** MAL-V15-RUNTIME-KERNEL-01

## Purpose
Provide official implementation guidance for Runtime Kernel inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V15-RUNTIME-KERNEL-01 | Governs Runtime Kernel. |
...
| --- | --- | --- | --- |
| v76 draft | 2026-06-29 | Draft | Added official documentation for Runtime Kernel. |
