...
Version: draft
Status: Active
Document ID: architecture-library/volume-42-bootstrap-installer-platform/installer-42-03-docker-bundle.md

## Purpose
Bundles required services such as Postgres, Redis, MinIO, Ollama, API, workers, and dashboard.
