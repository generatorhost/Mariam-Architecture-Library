# Desktop and VPS Modes

Version: draft
Status: Active
Document ID: architecture-library/volume-42-bootstrap-installer-platform/installer-42-07-desktop-vps.md

## Purpose
Supports desktop icon, tray/launcher, localhost mode, and VPS deployment.
