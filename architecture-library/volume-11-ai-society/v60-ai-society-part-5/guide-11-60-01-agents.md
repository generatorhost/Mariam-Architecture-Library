...
**Version:** v60 draft
**Status:** Draft
**Document ID:** MAL-V11-AGENTS-01

## Purpose
Provide official implementation guidance for Agents inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V11-AGENTS-01 | Governs Agents. |
...
| --- | --- | --- | --- |
| v60 draft | 2026-06-29 | Draft | Added official documentation for Agents. |
