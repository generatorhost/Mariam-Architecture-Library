...
**Version:** v128 draft
**Status:** Draft
**Document ID:** MAL-V27-LEGACY-02

## Purpose
Document the safe legacy seed extracted from ai-business-os for the pipeline model for leads, proposals, negotiations, approvals, won work, lost work, and post-sale delivery transitions. This document preserves historical product and infrastructure intent while preventing unsafe migration of code, secrets, runtime data, or implementation-specific coupling.
...
## Extracted Pattern
- Treat `Sales Pipeline` as a canonical capability candidate, not as copied implementation.
...
| MAL-V27-LEGACY-02 | Safe v128 analysis of Sales Pipeline. |
...
| --- | --- | --- | --- |
| v128 draft | 2026-06-30 | Draft | Added safe legacy seed analysis for Sales Pipeline. |
