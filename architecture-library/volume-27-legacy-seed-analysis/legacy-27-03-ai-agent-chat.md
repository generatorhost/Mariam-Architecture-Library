...
**Version:** v128 draft
**Status:** Draft
**Document ID:** MAL-V27-LEGACY-03

## Purpose
Document the safe legacy seed extracted from ai-business-os for the execution chat pattern where agents, chief, reviewers, and operators coordinate work through traceable conversations. This document preserves historical product and infrastructure intent while preventing unsafe migration of code, secrets, runtime data, or implementation-specific coupling.
...
- Legacy seed identified AI Agent Chat as an important operational pattern for an AI business operating system.
...
## Extracted Pattern
- Treat `AI Agent Chat` as a canonical capability candidate, not as copied implementation.
...
| MAL-V27-LEGACY-03 | Safe v128 analysis of AI Agent Chat. |
...
| --- | --- | --- | --- |
| v128 draft | 2026-06-30 | Draft | Added safe legacy seed analysis for AI Agent Chat. |
