...
**Version:** v128 draft
**Status:** Draft
**Document ID:** MAL-V27-LEGACY-01

## Purpose
Document the safe legacy seed extracted from ai-business-os for the customer relationship workspace for accounts, contacts, conversations, opportunities, client state, follow-up, and delivery context. This document preserves historical product and infrastructure intent while preventing unsafe migration of code, secrets, runtime data, or implementation-specific coupling.
...
- Legacy seed preserved the business-operating-system idea: client relationship, opportunities, proposal, follow-up, and delivery state belong in the product surface.
- Mariam should keep the workspace and pipeline model as first-class enterprise screens connected to communications, approvals, and delivery.
- No customer records, lead data, proposals, or conversation transcripts are copied.

## Extracted Pattern
- Treat `CRM Workspace` as a canonical capability candidate, not as copied implementation.
...
| MAL-V27-LEGACY-01 | Safe v128 analysis of CRM Workspace. |
...
| --- | --- | --- | --- |
| v128 draft | 2026-06-30 | Draft | Added safe legacy seed analysis for CRM Workspace. |
