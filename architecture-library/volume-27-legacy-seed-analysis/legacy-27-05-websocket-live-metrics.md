...
**Version:** v128 draft
**Status:** Draft
**Document ID:** MAL-V27-LEGACY-05

## Purpose
Document the safe legacy seed extracted from ai-business-os for the live operational metric stream for dashboards, job progress, service health, and execution telemetry. This document preserves historical product and infrastructure intent while preventing unsafe migration of code, secrets, runtime data, or implementation-specific coupling.
...
- Legacy seed suggested live dashboard metrics streamed to the interface for service status and operational progress.
- Mariam should represent this as a Live Metrics Channel with authenticated subscriptions and filtered event topics.
- No runtime event payloads or production telemetry values are copied.

## Extracted Pattern
- Treat `WebSocket Live Metrics` as a canonical capability candidate, not as copied implementation.
...
| MAL-V27-LEGACY-05 | Safe v128 analysis of WebSocket Live Metrics. |
...
| --- | --- | --- | --- |
| v128 draft | 2026-06-30 | Draft | Added safe legacy seed analysis for WebSocket Live Metrics. |
