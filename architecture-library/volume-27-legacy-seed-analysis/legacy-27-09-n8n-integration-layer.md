...
**Title:** n8n Integration Layer
**Version:** v128 draft
**Status:** Draft
**Document ID:** MAL-V27-LEGACY-09

## Purpose
Document the safe legacy seed extracted from ai-business-os for the workflow automation integration layer for external triggers, scheduled jobs, webhook actions, and business process handoffs. This document preserves historical product and infrastructure intent while preventing unsafe migration of code, secrets, runtime data, or implementation-specific coupling.
...
- Legacy seed identified n8n Integration Layer as a practical infrastructure or integration capability.
...
## Extracted Pattern
- Treat `n8n Integration Layer` as a canonical capability candidate, not as copied implementation.
...
| MAL-V27-LEGACY-09 | Safe v128 analysis of n8n Integration Layer. |
...
| --- | --- | --- | --- |
| v128 draft | 2026-06-30 | Draft | Added safe legacy seed analysis for n8n Integration Layer. |
