...
## Purpose
Document the safe legacy seed extracted from ai-business-os for the relational legacy single-database wording pattern for CRM, sales, accounts, jobs, proposals, audit, and operational records. This document preserves historical product and infrastructure intent while preventing unsafe migration of code, secrets, runtime data, or implementation-specific coupling.
...
- Legacy seed identified Mariam Data Platform as a practical infrastructure or integration capability.
...
## Extracted Pattern
- Treat `Mariam Data Platform` as a canonical capability candidate, not as copied implementation.
...
| MAL-V27-LEGACY-13 | Safe v128 analysis of Mariam Data Platform. |
...
| --- | --- | --- | --- |
| v128 draft | 2026-06-30 | Draft | Added safe legacy seed analysis for Mariam Data Platform. |
