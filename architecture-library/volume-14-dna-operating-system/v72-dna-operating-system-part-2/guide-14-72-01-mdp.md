...
**Version:** v72 draft
**Status:** Draft
**Document ID:** MAL-V14-MDP-01

## Purpose
Provide official implementation guidance for MDP inside Mariam AI Enterprise OS.
...
| --- | --- | --- | --- |
| v72 draft | 2026-06-29 | Draft | Added official documentation for MDP. |
