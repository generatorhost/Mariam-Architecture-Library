...
**Version:** v75 draft
**Status:** Draft
**Document ID:** MAL-V14-EXPORT-02

## Purpose
Provide official implementation guidance for Export inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V14-EXPORT-02 | Governs Export. |
...
| --- | --- | --- | --- |
| v75 draft | 2026-06-29 | Draft | Added official documentation for Export. |
