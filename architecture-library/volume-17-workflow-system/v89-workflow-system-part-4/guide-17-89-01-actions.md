...
**Version:** v89 draft
**Status:** Draft
**Document ID:** MAL-V17-ACTIONS-01

## Purpose
Provide official implementation guidance for Actions inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V17-ACTIONS-01 | Governs Actions. |
...
| --- | --- | --- | --- |
| v89 draft | 2026-06-29 | Draft | Added official documentation for Actions. |
