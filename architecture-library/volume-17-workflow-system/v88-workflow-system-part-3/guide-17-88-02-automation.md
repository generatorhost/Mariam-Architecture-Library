...
**Version:** v88 draft
**Status:** Draft
**Document ID:** MAL-V17-AUTOMATION-02

## Purpose
Provide official implementation guidance for Automation inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V17-AUTOMATION-02 | Governs Automation. |
| Volume 05 | Engineering standards reference. |
| RELEASE_NOTES_v88_draft.md | Release evidence. |

## Version History
| Version | Date | Status | Notes |
| --- | --- | --- | --- |
| v88 draft | 2026-06-29 | Draft | Added official documentation for Automation. |
