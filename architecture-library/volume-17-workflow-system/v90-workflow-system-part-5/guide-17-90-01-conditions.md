...
**Version:** v90 draft
**Status:** Draft
**Document ID:** MAL-V17-CONDITIONS-01

## Purpose
Provide official implementation guidance for Conditions inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V17-CONDITIONS-01 | Governs Conditions. |
...
| --- | --- | --- | --- |
| v90 draft | 2026-06-29 | Draft | Added official documentation for Conditions. |
