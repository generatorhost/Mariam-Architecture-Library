...
**Version:** v90 draft
**Status:** Draft
**Document ID:** MAL-V17-WORKFLOW-GOVERNANCE-02

## Purpose
Provide official implementation guidance for Workflow Governance inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V17-WORKFLOW-GOVERNANCE-02 | Governs Workflow Governance. |
| Volume 05 | Engineering standards reference. |
| RELEASE_NOTES_v90_draft.md | Release evidence. |

## Version History
| Version | Date | Status | Notes |
| --- | --- | --- | --- |
| v90 draft | 2026-06-29 | Draft | Added official documentation for Workflow Governance. |
