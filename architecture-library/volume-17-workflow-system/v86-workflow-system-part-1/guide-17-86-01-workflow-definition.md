...
**Version:** v86 draft
**Status:** Draft
**Document ID:** MAL-V17-WORKFLOW-DEFINITION-01

## Purpose
Provide official implementation guidance for Workflow Definition inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V17-WORKFLOW-DEFINITION-01 | Governs Workflow Definition. |
| Volume 05 | Engineering standards reference. |
| RELEASE_NOTES_v86_draft.md | Release evidence. |

## Version History
| Version | Date | Status | Notes |
| --- | --- | --- | --- |
| v86 draft | 2026-06-29 | Draft | Added official documentation for Workflow Definition. |
