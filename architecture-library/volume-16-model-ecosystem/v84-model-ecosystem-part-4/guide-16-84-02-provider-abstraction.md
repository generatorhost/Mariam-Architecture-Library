...
**Version:** v84 draft
**Status:** Draft
**Document ID:** MAL-V16-PROVIDER-ABSTRACTION-02

## Purpose
Provide official implementation guidance for Provider Abstraction inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V16-PROVIDER-ABSTRACTION-02 | Governs Provider Abstraction. |
| Volume 05 | Engineering standards reference. |
| RELEASE_NOTES_v84_draft.md | Release evidence. |

## Version History
| Version | Date | Status | Notes |
| --- | --- | --- | --- |
| v84 draft | 2026-06-29 | Draft | Added official documentation for Provider Abstraction. |
