...
**Version:** v82 draft
**Status:** Draft
**Document ID:** MAL-V16-ONNX-01

## Purpose
Provide official implementation guidance for ONNX inside Mariam AI Enterprise OS.
...
| Source | Relationship |
| --- | --- |
| MAL-V16-ONNX-01 | Governs ONNX. |
| Volume 05 | Engineering standards reference. |
| RELEASE_NOTES_v82_draft.md | Release evidence. |

## Version History
| Version | Date | Status | Notes |
| --- | --- | --- | --- |
| v82 draft | 2026-06-29 | Draft | Added official documentation for ONNX. |
