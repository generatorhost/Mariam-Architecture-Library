...
**Version:** v82 draft
**Status:** Draft
**Document ID:** MAL-V16-VLLM-02

## Purpose
Provide official implementation guidance for vLLM inside Mariam AI Enterprise OS.
...
| --- | --- | --- | --- |
| v82 draft | 2026-06-29 | Draft | Added official documentation for vLLM. |
