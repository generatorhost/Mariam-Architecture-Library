...
**Title:** Governance & Approvals UI
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-28

## Purpose
Defines approval queues, policy gates, risk indicators, reviewer actions, audit evidence, and escalation flows. Approval screens must make risk, evidence, reviewer authority, and final decision state unmistakable.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-28 | Defines v127 Experience & Interface Design for Governance & Approvals UI. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Governance & Approvals UI interface design documentation. |
