...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-01

## Purpose
Defines the official visual token set adopted from index(2).html for the Mariam dashboard and command center interface. This document makes the index(2).html colors official design tokens for Mariam AI Enterprise OS interface work.
...
## Core Components
- Token table showing exact CSS custom property names and values.
- Semantic state mapping for success, warning, failure, primary action, and AI-intelligence accents.
- Contrast guidance for dense dark enterprise dashboards.
- Usage rules for panels, tables, chat, queues, alerts, and approval flows.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-01 | Defines v127 Experience & Interface Design for Design Tokens. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Design Tokens interface design documentation. |
