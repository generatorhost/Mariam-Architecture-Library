...
**Title:** Task & Jobs Center
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-07

## Purpose
Defines the interface for task queues, running jobs, retries, scheduled work, ownership, dependencies, and completion evidence. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-07 | Defines v127 Experience & Interface Design for Task & Jobs Center. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Task & Jobs Center interface design documentation. |
