...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-25

## Purpose
Defines knowledge search, documents, memory, citations, source freshness, review status, and knowledge graph navigation. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-25 | Defines v127 Experience & Interface Design for Knowledge Center. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Knowledge Center interface design documentation. |
