...
**Title:** Chief Chat Panel
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-04

## Purpose
Defines the primary chief conversation panel used for executive instruction, mission creation, status review, approvals, and intervention. Chat is an execution surface connected to missions, evidence, approvals, and agent state, not a casual messaging widget.
...
## Core Components
- Conversation timeline with message source, role, confidence, action links, and evidence chips.
- Composer with command mode, attachment mode, approval request mode, and mission reference mode.
- Side inspector for agent state, mission context, risks, pending approvals, and related documents.
- Escalation controls for review, pause, retry, delegate, and approve.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-04 | Defines v127 Experience & Interface Design for Chief Chat Panel. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Chief Chat Panel interface design documentation. |
