...
**Title:** Remote Work Workspace
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-17

## Purpose
Defines remote job discovery, applications, interviews, employer conversations, and work pipeline interfaces. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-17 | Defines v127 Experience & Interface Design for Remote Work Workspace. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Remote Work Workspace interface design documentation. |
