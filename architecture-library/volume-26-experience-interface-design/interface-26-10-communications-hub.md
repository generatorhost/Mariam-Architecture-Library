...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-10

## Purpose
Defines the unified communications inbox and outbound control surface for client, marketplace, and internal conversations. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-10 | Defines v127 Experience & Interface Design for Communications Hub. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Communications Hub interface design documentation. |
