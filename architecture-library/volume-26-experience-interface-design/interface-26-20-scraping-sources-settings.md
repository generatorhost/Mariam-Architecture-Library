...
**Title:** Scraping Sources Settings
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-20

## Purpose
Defines source manager settings for websites, marketplaces, remote boards, social channels, credentials references, scope, and frequency. Scraping is a visible standalone operations system for discovering and validating external opportunities before proposal generation.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-20 | Defines v127 Experience & Interface Design for Scraping Sources Settings. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Scraping Sources Settings interface design documentation. |
