...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-29

## Purpose
Defines enterprise configuration, integrations, permissions, design preferences, notification rules, scraping policies, and release settings. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-29 | Defines v127 Experience & Interface Design for Settings. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Settings interface design documentation. |
