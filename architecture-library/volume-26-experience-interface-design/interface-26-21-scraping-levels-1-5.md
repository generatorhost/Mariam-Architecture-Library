...
**Title:** Scraping Levels 1-5
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-21

## Purpose
Defines visible controls and explanations for five crawl depths, crawl policies, extraction breadth, and risk boundaries. Scraping is a visible standalone operations system for discovering and validating external opportunities before proposal generation.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-21 | Defines v127 Experience & Interface Design for Scraping Levels 1-5. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Scraping Levels 1-5 interface design documentation. |
