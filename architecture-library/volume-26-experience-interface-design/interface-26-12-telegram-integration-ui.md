...
**Title:** Telegram Integration UI
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-12

## Purpose
Defines Telegram channel, bot, chat, approval, notification, and operational controls. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-12 | Defines v127 Experience & Interface Design for Telegram Integration UI. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Telegram Integration UI interface design documentation. |
