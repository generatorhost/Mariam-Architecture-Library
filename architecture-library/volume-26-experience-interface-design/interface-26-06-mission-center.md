...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-06

## Purpose
Defines the mission workspace for intake, planning, phase tracking, task graph progress, evidence, and acceptance state. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-06 | Defines v127 Experience & Interface Design for Mission Center. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Mission Center interface design documentation. |
