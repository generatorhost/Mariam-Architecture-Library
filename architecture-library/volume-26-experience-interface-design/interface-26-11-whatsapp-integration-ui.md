...
**Title:** WhatsApp Integration UI
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-11

## Purpose
Defines WhatsApp account, thread, consent, template, attachment, delivery, and approval interfaces. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-11 | Defines v127 Experience & Interface Design for WhatsApp Integration UI. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added WhatsApp Integration UI interface design documentation. |
