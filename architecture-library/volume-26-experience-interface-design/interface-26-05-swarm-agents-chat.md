...
**Title:** Swarm Agents Chat
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-05

## Purpose
Defines multi-agent chat surfaces for swarm coordination, agent state, handoffs, review comments, and execution telemetry. Chat is an execution surface connected to missions, evidence, approvals, and agent state, not a casual messaging widget.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-05 | Defines v127 Experience & Interface Design for Swarm Agents Chat. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Swarm Agents Chat interface design documentation. |
