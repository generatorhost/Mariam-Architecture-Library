# Reports Approval Center

**Title:** Reports Approval Center
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-08

## Purpose
Defines report review, signoff, escalation, rejection, revision, and executive approval surfaces. Approval screens must make risk, evidence, reviewer authority, and final decision state unmistakable.
...
## Core Components
- Approval queue with priority, risk, owner, deadline, linked mission, and evidence status.
- Decision panel with approve, reject, request changes, escalate, and hold actions.
- Audit trail showing policy, reviewer, timestamp, decision reason, and artifact version.
- Risk badges using yellow, red, blue, green, and purple tokens consistently.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-08 | Defines v127 Experience & Interface Design for Reports Approval Center. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Reports Approval Center interface design documentation. |
