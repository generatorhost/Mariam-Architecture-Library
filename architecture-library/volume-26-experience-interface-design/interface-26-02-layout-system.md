...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-02

## Purpose
Defines desktop, tablet, and mobile layout behavior for navigation, panels, workspaces, density, resizing, and persistent command surfaces. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-02 | Defines v127 Experience & Interface Design for Layout System. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Layout System interface design documentation. |
