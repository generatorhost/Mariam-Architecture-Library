...
**Title:** DNA Packages UI
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-26

## Purpose
Defines DNA package inventory, import, validation, dependency graph, versioning, hot reload status, and export controls. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-26 | Defines v127 Experience & Interface Design for DNA Packages UI. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added DNA Packages UI interface design documentation. |
