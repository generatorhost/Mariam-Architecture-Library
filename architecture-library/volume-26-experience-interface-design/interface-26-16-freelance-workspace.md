...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-16

## Purpose
Defines freelance profile, opportunities, proposals, conversations, delivery, milestone, and payment tracking interfaces. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-16 | Defines v127 Experience & Interface Design for Freelance Workspace. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Freelance Workspace interface design documentation. |
