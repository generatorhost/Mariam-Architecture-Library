...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-19

## Purpose
Defines scoring, ranking, fit, freshness, competition, profitability, and readiness dashboards for extracted opportunities. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-19 | Defines v127 Experience & Interface Design for Opportunity Intelligence Dashboard. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Opportunity Intelligence Dashboard interface design documentation. |
