...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-15

## Purpose
Defines calendar, scheduling, reminders, mission deadlines, interviews, client meetings, and automation windows. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-15 | Defines v127 Experience & Interface Design for Calendar & Scheduler. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Calendar & Scheduler interface design documentation. |
