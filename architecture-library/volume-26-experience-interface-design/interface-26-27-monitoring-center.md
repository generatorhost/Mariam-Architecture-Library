...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-27

## Purpose
Defines runtime health, agent health, model health, queue depth, crawl metrics, alerts, incidents, and SLA dashboards. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-27 | Defines v127 Experience & Interface Design for Monitoring Center. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Monitoring Center interface design documentation. |
