...
**Title:** Email Integration UI
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-13

## Purpose
Defines email inbox, outbound draft, thread, attachment, signature, template, and approval interfaces. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-13 | Defines v127 Experience & Interface Design for Email Integration UI. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Email Integration UI interface design documentation. |
