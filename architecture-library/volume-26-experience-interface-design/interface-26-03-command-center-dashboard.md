...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-03

## Purpose
Defines the main operational dashboard where executives, chiefs, operators, and agents see missions, jobs, opportunities, alerts, and approvals. The Command Center is the first real screen of the product and must prioritize operational control over marketing or diagrammatic presentation.
...
## Core Components
- Left navigation rail for Mission Center, Scraping, Opportunities, Communications, Knowledge, Marketplace, Monitoring, Governance, and Settings.
- Top command bar with search, global status, active workspace, notifications, and account controls.
- Main KPI strip for missions, active jobs, crawl queue, approvals, opportunity score, and incidents.
- Resizable work panels for Chief chat, job monitor, opportunity intelligence, and approval queue.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-03 | Defines v127 Experience & Interface Design for Command Center Dashboard. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Command Center Dashboard interface design documentation. |
