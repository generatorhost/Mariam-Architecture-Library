# SMS / Calls / Contacts UI

**Title:** SMS / Calls / Contacts UI
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-14

## Purpose
Defines SMS, call log, callback, contact profile, consent, and outreach tracking interfaces. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-14 | Defines v127 Experience & Interface Design for SMS / Calls / Contacts UI. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added SMS / Calls / Contacts UI interface design documentation. |
