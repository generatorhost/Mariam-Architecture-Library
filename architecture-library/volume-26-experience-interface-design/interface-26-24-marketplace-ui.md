...
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-24

## Purpose
Defines marketplace browsing, package cards, provider listings, plugins, templates, assets, install state, and governance badges. The screen must support repeated enterprise work, dense scanning, fast decisions, and clear state transitions.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-24 | Defines v127 Experience & Interface Design for Marketplace UI. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Marketplace UI interface design documentation. |
