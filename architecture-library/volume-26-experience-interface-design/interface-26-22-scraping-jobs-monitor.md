# Scraping Jobs Monitor

**Title:** Scraping Jobs Monitor
**Version:** v127 draft
**Status:** Draft
**Document ID:** MAL-V26-EXP-22

## Purpose
Defines crawl job observability, queue progress, failed crawls, retries, deduplication, alerts, and manual review surfaces. Scraping is a visible standalone operations system for discovering and validating external opportunities before proposal generation.
...
| Source | Relationship |
| --- | --- |
| MAL-V26-EXP-22 | Defines v127 Experience & Interface Design for Scraping Jobs Monitor. |
...
| --- | --- | --- | --- |
| v127 draft | 2026-06-30 | Draft | Added Scraping Jobs Monitor interface design documentation. |
