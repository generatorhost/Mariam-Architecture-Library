# Volume 41 - Mariam Plugin Development Kit v146

Version: draft
Status: Active
Document ID: architecture-library/volume-41-mariam-plugin-development-kit/README.md

## Purpose
Overview for Volume 41 - Mariam Plugin Development Kit v146.
