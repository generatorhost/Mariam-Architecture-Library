...
Version: draft
Status: Active
Document ID: architecture-library/volume-41-mariam-plugin-development-kit/mpdk-41-04-mcp-sdk.md

## Purpose
Defines MCP server packaging, tools, resources, permissions, audit, and marketplace registration.
