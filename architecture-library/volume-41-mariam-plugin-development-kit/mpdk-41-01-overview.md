...
Version: draft
Status: Active
Document ID: architecture-library/volume-41-mariam-plugin-development-kit/mpdk-41-01-overview.md

## Purpose
Official SDK for creating plugins, providers, connectors, MCP servers, workflows, dashboards, themes, widgets, and DNA packages.
